  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Issue, manage, and verify official medical certificates for clinic patients"
        action={
          <div className="flex gap-3">
            <Link href="/owner/certificates/templates" className="clinic-btn clinic-btn-secondary gap-2 text-xs">
              <FileText className="h-4 w-4" /> Template Library
            </Link>
            <Link href="/owner/certificates/new" className="clinic-btn clinic-btn-primary gap-2 text-xs">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="flex flex-wrap gap-2 text-xs">
          ...
          <Link
            href="/owner/certificates?status=issued"
          ...
          <Link
            href="/owner/certificates?status=revoked"
          ...
          {certificates.length === 0 ? (
            ...
            certificates.map((cert) => (
              <TableRow key={cert.id}>
                <TableCell>
                  <Link href={`/owner/certificates/${cert.id}`} className="font-mono text-xs font-bold text-teal-700 hover:underline">
